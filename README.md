...
This portfolio contains a summary of my work, including machine learning exercises and reflections.
...
1.  **[Hyperparameter ray](./4.%20Hypertuning%20RAY/summary.md)**
    * A summary of my findings from tuning a Random Forest Classifier.
1.  **[deployment](./5-Deployment/straattaal/summary.md)**
    * The result of my own deployment
1.  **[Ethics](./6.%20Ethics/summary.md)**
